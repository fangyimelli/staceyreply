...
try {
  ...
  await writeFile(
    ...
    JSON.stringify({
      ...
      files: [
        ...
        path.resolve('src/instruments.ts'),
  ...
  const base = (overrides = {}) => ({
    ...
    instrument: { pairKey: 'eurusd', symbol: 'EURUSD', assetClass: 'fx', quotePrecision: 5, tickSize: 0.00001, pipSize: 0.0001, pointSize: 0.00001, preferredStopPips: 12, maxStopPips: 20, maxStopPoints: 200 },
    candidateEntryPrice: 1.1015,
    stopPrice: 1.1002,
    stopDistancePips: 13,
