...
- [x] TP levels must be displayed as TradingView-like boxes/zones
- [x] After entry, chart/replay must continue until New York session end
- [x] Right-side explain panel with rule-based reasoning
- [x] Explain panel must continue updating after entry
